---
name: ars-frontend-design
description: >-
  Enforces ARS frontend design and localization rules. Use whenever creating or modifying UI components,
  pages, modals, notifications, empty states, or forms. Covers theme tokens, yellow/white/black palette,
  lucide-react icons, strict bilingual English/Vietnamese localization, and typography standards.
---
