...
import * as useMajorFieldsModule from '../../hooks/useMajorFields';
import * as usePapersModule from '../../hooks/usePapers';
import * as usePaperReviewLocksModule from '../../hooks/usePaperReviewLocks';
import * as useAuthenticatedResearcherModule from '../../hooks/useAuthenticatedResearcher';
import * as paperServiceModule from '../../services/paper.service';

vi.mock('../../hooks/useMajorFields');
vi.mock('../../hooks/usePapers');
vi.mock('../../hooks/usePaperReviewLocks');
vi.mock('../../hooks/useAuthenticatedResearcher');
