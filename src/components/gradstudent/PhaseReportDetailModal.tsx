            ...
            <div className={styles.metaItem}>
              ...
              <span className={styles.metaValue}>
                ...
                {report.deadlineAt
                  ...
                  ? new Date(report.deadlineAt).toLocaleString(locale === 'en' ? 'en-US' : 'vi-VN', {
            ...
            <div className={styles.metaItem}>
              ...
              <span className={styles.metaValue}>
                ...
                {report.submittedAt
                  ...
                  ? new Date(report.submittedAt).toLocaleString(locale === 'en' ? 'en-US' : 'vi-VN', {
                ...
                {typeof report.lectureFeedback === 'number' && (
                  ...
                  <div className={styles.scoreRow}>
                    ...
                    <span className={styles.scorePill}>
                      ...
                      {/* No star icons in this UI (workspace rule). The
                          original used `Star` here; we swap to `Badge`
                          (a non-star lucide icon that visually fits the
                          rounded "score pill" silhouette). */}
                      <Badge size={14} />
