...
const HeroAct = ({ t }: { t: (k: string, f: string, p?: Record<string, string | number>) => string }) => {
...
const TensionAct = ({ t }: { t: (k: string, f: string, p?: Record<string, string | number>) => string }) => {
...
const TurnAct = ({ t }: { t: (k: string, f: string, p?: Record<string, string | number>) => string }) => {
...
const SubstanceAct = ({ t }: { t: (k: string, f: string, p?: Record<string, string | number>) => string }) => {
...
const CommitmentSection = ({ t }: { t: (k: string, f: string, p?: Record<string, string | number>) => string }) => {
...
const Header = ({ t }: { t: (k: string, f: string, p?: Record<string, string | number>) => string }) => {
...
const Footer = ({ t }: { t: (k: string, f: string, p?: Record<string, string | number>) => string }) => (
