          ...
          <ul className={styles.materialList}>
            ...
            {visibleMaterials.map((m) => (
              ...
              <li key={m.id ?? m.learningMaterialId ?? m.title} className={styles.materialItem}>
                ...
                {m.fileUrl && safeHref(m.fileUrl) ? <a href={safeHref(m.fileUrl) ?? '#'} target="_blank" rel="noopener noreferrer" className={styles.linkBtn}>{copy('Open PDF', 'Xem PDF')}</a> : null}
                        ...
                        <td>
                          ...
                          <div className={styles.rowActions}>
                            ...
                            {report.reportFileUrl ? (
                              ...
                              <a href={safeHref(report.reportFileUrl) ?? '#'} target="_blank" rel="noopener noreferrer" className={styles.linkBtn}>{copy('Open PDF', 'Xem PDF')}</a>
